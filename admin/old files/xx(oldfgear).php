...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/fgears.css">
        ...
        <!-------------------------------------------------------------Dashboard-Contents--------------------------------------------------------->
            ...
            <div class = "dash-body">
                <table border="0" width="100%" style="border-spacing: 0; margin: 0; padding: 0;">
                        ...
                        <tr >
                            <td colspan="6">
                             <table class="fgear-con">
                                 <tr>
                                     
                                     <div class ="fgear-con-items">
                                         <div class="fgear-card">
                                             <div class="fg-img">
                                             ...
                                             <div class="fg-butt">
                                                <button><A href="fg_newreg.php">SELECT</A></button>
                                            </div>
                                         </div>
