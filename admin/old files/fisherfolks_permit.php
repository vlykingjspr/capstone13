...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/ffolkspermit.css">
        ...
        <!-------------------------------------------------------------Dashboard-Contents--------------------------------------------------------->
            ...
            <div class = "dash-body">
                <table border="0" width="100%" style="border-spacing: 0; margin: 0; padding: 0;">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding-left: 1%;font-size: 23px; width: 30%;">
                                            <p style="color: #3E897B; font-weight: bold;" class="dhead">CAGRO ◌ FISHERFOLKS PERMIT TYPE</p>
                                        </td>
                                    </tr>  
                                </table>
                            </td>
                        ...
                        <tr>
                           <td colspan="6">
                            <table class="permit-con">
                                <tr>
                                    <div class ="permit-con-items">
                                        <div class="permit-card">
                                            ...
                                            <div class="p-butt">
                                                <button><A href="fisherfolks_newreg.php">SELECT</A></button>
                                            </div>
                                        </div>
