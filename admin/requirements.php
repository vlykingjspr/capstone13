                                ...
                                <div class="fgnew-card-slim">
                                    ...
                                    <div class="fg-fields-check-slim">
                                        ...
                                        <label class="check-box">BRGY. CLEARANCE/CERTIFICATION
                                            <input type="checkbox" class="cbox" name="requirements[]" value="BRGY. CLEARANCE/CERTIFICATION">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">CEDULA
                                            <input type="checkbox" class="cbox" name="requirements[]" value="CEDULA">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">FARMC CERTIFICATION
                                            <input type="checkbox" class="cbox" name="requirements[]" value="FARMC CERTIFICATION">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">2x2 I.D. PICTURE (2PCS)
                                            <input type="checkbox" class="cbox" name="requirements[]" value="2x2 I.D. PICTURE (2PCS)">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">PNP MARITIME CLEARANCE
                                            <input type="checkbox" class="cbox" name="requirements[]" value="PNP MARITIME CLEARANCE">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">ADMEASUREMENTS
                                            <input type="checkbox" class="cbox" name="requirements[]" value="ADMEASUREMENTS">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">FISHERY LICENSE I.D
                                            <input type="checkbox" class="cbox" name="requirements[]" value="FISHERY LICENSE I.D">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">OLD BOAT PERMIT (FOR RENEWAL)
                                            <input type="checkbox" class="cbox" name="requirements[]" value="OLD BOAT PERMIT (FOR RENEWAL)">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">OLD PERMIT (RENEWAL)
                                            <input type="checkbox" class="cbox" name="requirements[]" value="OLD PERMIT (RENEWAL)">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="check-box">FISHERY LICENSE I.D
                                            <input type="checkbox" class="cbox" name="requirements[]" value="FISHERY LICENSE I.D">
                                    ...
                                    <div class="fg-header-slim">
                                        <div style="justify-content: space-between; display:flex;">
                                            ...
                                            <div style="display: flex; align-items: center;">
                                                <button type="button" onclick="addRow()">Add Payment</button>
                    ...
                    <tr>
                        <td>
                            <div style="justify-content:center; display: flex">
                                <button class="btn" onclick="prepareData()">Generate List</button>
                            </div>
