...
<head>
    ...
    <title>Fisherfolk License</title>
</head>
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT
                client_gender,
                CONCAT(client_fname, ' ', client_mname, ' ', client_lname) AS name,
                CONCAT(client_street, ', ', client_brgy, ', ', client_municipal, ', ', client_prov) AS address,
                client_OR
            FROM licensing
            WHERE client_id = ?";
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            $stmt->execute();
            $stmt->bind_result($gender, $name, $address, $orNumber);
            $stmt->fetch();
            $stmt->close();
        }
            ...
            <div class="dash-body">
                <table border="0" width="100%" style="border-spacing: 0; margin: 0; padding: 0;">
                            ...
                            <div class="style-inline" style="display: flex; justify-content: space-between">
                                <div style="display: flex; float:left">
                                    <div class="animx" style="margin: auto; padding-inline: 0.5rem">
                                        <a href="../licensing.php"><img src="../../img/icons/back-butt.png" class="back-img selector"></a>
                                    </div>
                                        ...
                                        <div style="display:flex !important;">
                                            ...
                                            <div style="width: 50%">
                                                <div class="style-inline" style="display:flex; margin:auto; padding-top: 1.5rem">
                                                    ...
                                                    <div class="style-inline" style="text-align: center">
                                                        <p style="color: black; margin:0; border-bottom: 1px solid black">Nick Gurr</p><!-- Use PHP to echo the current logged-in user name -->
                                                        <p class="license-titles">CITY MAYOR</p>
                                                    </div>
                                                </div>
                    ...
                    <tr>
                        <td>
                            <div style="justify-content: center; display:flex">
                                <button id="btn-print-this" style="text-align:center; padding: 10px; border-radius: 5px; border-style:none; cursor: pointer; background-color: #58A773; color: white; margin: 10px; text-decoration:none">SAVE AND PRINT</button>
                            </div>
                        </td>
                    </tr>
